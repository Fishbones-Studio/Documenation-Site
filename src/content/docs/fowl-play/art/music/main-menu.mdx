...
- **Dubstep Crash 3**: Used as a _mysterious recurring sound_ throughout **section 1** and **section 3**.
...
![Main Menu Theme Arrangement](../../../../../assets/fowl-play/art/music/main-menu/arrangement.png)
...
- **Track 1**
  - _Fruity blood overdrive_: To make the chords distorted.
  - _Fruity limiter_: So the chords don't overpower within the song.
- **Track 2**
  - _Fruity Reeverb 2_: Reverb
  - _Soundgoodizer_: makes it sound fuller.
  - _Gross Beat_: Used to create a stuttering effect by automating volume patterns. This effect causes the sound to rapidly alternate between higher and lower levels.
  - _Fruity Multiband Compressor_: Compression
  - _Parametric EQ 2_: To take out the lows and highs.
  - _Fruity limiter_: To mix it better within the song.
