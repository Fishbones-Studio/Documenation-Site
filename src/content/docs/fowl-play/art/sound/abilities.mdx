...
<AudioPlayer
  ...
  description="Sounds like a firework going off, after which a thunder sound effect plays. Sound has been slightly distorted, and some reverb has been applied."
/>
