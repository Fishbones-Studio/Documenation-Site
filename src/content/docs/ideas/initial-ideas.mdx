...
![Swarm figurenes](../../../assets/brainstorm/initial_ideas/swarm_figurines.png)
(something like this)
...
The target audience for this game would be people who like a challenge, people who like to grind for better loot, and people who like to customize their characters.
PEGI rating 12+
...
- To get into the fighting game play part of the game there will be flyers of arenas you can contest in, the harder the arena the more currency you can earn.
  ![Chicken upgrade menu](../../../assets/brainstorm/initial_ideas/chicken_upgrade_menu.png)
...
![Chicken mutation ideas](../../../assets/brainstorm/initial_ideas/chicken_mutations.png)
...
<Subtitle>Tower defense, deck builder, 2D</Subtitle>
...
<Subtitle>Story, Puzzle, 3D</Subtitle>
...
<Subtitle>2D, Board Game, Visual Novel</Subtitle>
...
<Subtitle>3D, multiplayer</Subtitle>

Battle Royale with playable babies.

### Bound by Cards

<Subtitle>Extraction souls like, 3D, bosh rush?, rougelite</Subtitle>
